...
config :relay, RelayWeb.Endpoint,
  ...
  # Port defaults to 4000 but honors PORT so you can run alongside other Phoenix apps.
...
config :relay, RelayWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/relay_web/router\.ex$"E,
      ~r"lib/relay_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
