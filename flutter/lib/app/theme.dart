...
class RelayTheme {
  ...
  static const Color relayHumanLight = Color(0xFF3284D0); // primary · blue  (oklch 0.60 0.14 250)
  static const Color relayHumanDark = Color(0xFF3A93E6); //  primary · blue  (oklch 0.65 0.15 250)
  static const Color relayAILight = Color(0xFF795EC9); //    secondary · violet (oklch 0.56 0.16 292)
  static const Color relayAIDark = Color(0xFF9074E9); //     secondary · violet (oklch 0.64 0.17 292)
  static const Color relayDone = Color(0xFF4AB074); //       done · green  (oklch 0.68 0.13 155)
  static const Color relayBlocked = Color(0xFFD58C3B); //    blocked · amber (oklch 0.70 0.13 65)
