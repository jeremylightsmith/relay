      ...
      <div class="drawer-side z-40">
        ...
        <aside class="flex min-h-full w-full max-w-md flex-col gap-6 bg-base-100 p-5 shadow-xl">
          ...
          <section :if={@card.sub_tasks != []} id="sub-tasks" class="space-y-2">
            ...
            <ul class="space-y-1">
              <li :for={st <- @card.sub_tasks} id={"sub-task-#{st.id}"} class="flex items-start gap-2">
                <button
                  type="button"
                ...
                <span class={["text-sm leading-snug", st.done && "text-base-content/50 line-through"]}>
                  {st.title}
                </span>
              </li>
            </ul>
          ...
          <section :if={@card.ai_result} id="ai-result" class="space-y-2">
            ...
            >
              ...
              <ul
                ...
                class="space-y-1"
              >
                <li :for={change <- @card.ai_result["changes"]} class="flex items-start gap-2 text-sm">
