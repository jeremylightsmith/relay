defmodule RelayWeb.Router do
  ...
  # RE304 puts the scaffold here for the same reason: `/relay-setup` downloads `./relay`
  ...
  scope "/api", RelayWeb.Api do
    ...
    get "/flows/:key/audit", AuditController, :audit
    ...
    post "/cards/:ref/advance", RunController, :advance_card
    post "/runs/:id/advance", RunController, :advance
