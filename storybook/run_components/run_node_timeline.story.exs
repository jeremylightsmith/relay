  ...
  def variations do
    [
      %Variation{
        ...
        attributes: %{
          ...
          node_executions: [
            ...
            ne("quality_review", 1, :failed, %{duration_s: 48, cost: Decimal.new("0.35"), detail: "assert on CSV bytes"}),
      ...
      %Variation{
        ...
        attributes: %{
          run: run(%{status: :running, flow_key: "spec", current_node: "brainstorm"}),
          node_executions: [
      ...
      %Variation{
        id: :circuit,
        attributes: %{
          run: run(%{status: :failed, current_node: "quality_review", finished_at: DateTime.utc_now()}),
          node_executions: [
            ne("implement", 1, :succeeded, %{duration_s: 160, cost: Decimal.new("0.90")}),
